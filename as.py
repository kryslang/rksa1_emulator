...
ins=["ADD","SUB","REGWRITE","REGMOV","RAMW","RAMR","JMP","JPIE","JPIG","JPIS","INC","DEC","NOP","JPINE","BITSLEFT","HALT","BITSRIGHT","CALL","RET","REGSWAP", "MUL", "DIV"]
buff=""
buffc1=""
buffc2=""
buffc3=""
...
nextli=False
inse=0
lablist=["reg_k","reg_l","reg_j","reg_i","reg_a","reg_b","reg_c","reg_d","reg_e","reg_f","reg_g","reg_h","stdout","PC","AR","iport","oport","flag","call","ramsize"]
...
for i in f.readlines():
	...
	if(buffc1[0]=='0'):
		...
		for h in range(0,len(lablist)):
			if(buffc1==lablist[h]):
				if(h>19):
					f2.write((cordlist[h]).to_bytes(2, "big"))
				else:
